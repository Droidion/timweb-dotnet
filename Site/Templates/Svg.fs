...
module Svg =
    ...
    let timLogo =
        svg [ attr "fill" "none"
              attr "viewBox" "0 0 756 334"
              attr "xmlns" "http://www.w3.org/2000/svg"
              attr "xmlns:xlink" "http://www.w3.org/1999/xlink" ] [
            path [ attr "d" "m520 45h236v244h-236z"
                   attr "fill" "#000" ] []
            path [ attr "clip-rule" "evenodd"
                   attr "fill-rule" "evenodd"
                   attr "d" "m638.004 218-64.004-142 64-50.9961z"
                   attr "fill" "#f9b816" ] []
            path [ attr "clip-rule" "evenodd"
                   attr "fill-rule" "evenodd"
                   attr "d" "m638 218 64-142.0039-64-50.9961z"
                   attr "fill" "#f36c24" ] []
            path [ attr "d" "m260 45h236v244h-236z"
                   attr "fill" "#000" ] []
            g [ attr "clip-rule" "evenodd"
                attr "fill-rule" "evenodd" ] [
                path [ attr "d" "m313.746 191.173v-146.0001l74-20z"
                       attr "fill" "#f9b816" ] []
                path [ attr "d" "m313.462 191.427 108.499-97.693-34.652-68.3754z"
                       attr "fill" "#f36c24" ] []
                path [ attr "d" "m441.399 143.408v146l-74 20z"
                       attr "fill" "#f36c24" ] []
                path [ attr "d" "m441.682 143.153-108.499 97.694 34.653 68.375z"
                       attr "fill" "#f9b816" ] []
            ]
            path [ attr "d" "m0 116h236v172h-236z"
                   attr "fill" "#000" ] []
            path [ attr "d" "m118 25h118v74h-118z"
                   attr "fill" "#000" ] []
            path [ attr "d" "m0 25h118v74h-118z"
                   attr "fill" "#f9b816" ] []
            path [ attr "clip-rule" "evenodd"
                   attr "fill-rule" "evenodd"
                   attr
            ...
            path [ attr "clip-rule" "evenodd"
                   attr "fill-rule" "evenodd"
                   attr "d" "m117.996 116 64.004 142-64 50.996z"
                   attr "fill" "#f36c24" ] []
            path [ attr "clip-rule" "evenodd"
                   attr "fill-rule" "evenodd"
                   attr "d" "m118 116-64 142.004 64 50.996z"
                   attr "fill" "#f9b816" ] []
        ]

    /// Company icon
    let companyIcon =
        svg [ attr "viewBox" "0 0 25.7 25.7"
              attr "xmlns" "http://www.w3.org/2000/svg"
              attr "xmlns:xlink" "http://www.w3.org/1999/xlink" ] [
            path [ attr "fill" "#252627"
                   attr
                       "d"
    ...
    let vinkIcon =
        svg [ attr "viewBox" "0 0 26.17 26.3"
              attr "xmlns" "http://www.w3.org/2000/svg"
              attr "xmlns:xlink" "http://www.w3.org/1999/xlink" ] [
            path [ attr "fill" "#252627"
                   attr
